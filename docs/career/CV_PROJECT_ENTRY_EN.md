...
**End-to-End Commerce Analytics & Measurement Engineering Portfolio Project**

Built a privacy-separated commerce intelligence system for a Saudi digital-products context, combining deterministic synthetic data, six typed read-only connector paths, DuckDB/dbt, FastAPI, and a bilingual Next.js dashboard.

- Defined defensible KPI ownership across Commerce, GA4, Google Ads, Search Console, Merchant Center, and Clarity; surfaced reconciliation, freshness, event-completeness, and consent warnings instead of blending unlike sources.
